 ...
 * vector.
 */
export function setTranslation(a: Mat4, v: v3.Vec3, dst?: Mat4): Mat4 {
  dst = dst || identity()
  if (a !== dst) {
    dst[ 0 ] = a[ 0 ]
    dst[ 1 ] = a[ 1 ]
 ...
 * entries.
 */
export function getTranslation(m: Mat4, dst?: v3.Vec3): v3.Vec3 {
  dst = dst || v3.create()
  dst[ 0 ] = m[ 12 ]
  dst[ 1 ] = m[ 13 ]
  dst[ 2 ] = m[ 14 ]
 ...
 */
export function getAxis(m: Mat4, axis: number, dst?: v3.Vec3): v3.Vec3 {
  dst = dst || v3.create()
  const off = axis * 4
  dst[ 0 ] = m[ off + 0 ]
  dst[ 1 ] = m[ off + 1 ]
 ...
 */
export function setAxis(a: Mat4, v: v3.Vec3, axis: number, dst?: Mat4): Mat4 {
  if (dst !== a) {
    dst = copy(a, dst)
  }
  const off = axis * 4
...
export function lookAt(eye: v3.Vec3, target: v3.Vec3, up: v3.Vec3, dst?: Mat4): Mat4 {
  dst = dst || new Float32Array(16)
  const xAxis = tempV3a
  const yAxis = tempV3b
  const zAxis = tempV3c
 ...
 */
export function translation(v: v3.Vec3, dst?: Mat4): Mat4 {
  dst = dst || new Float32Array(16)
  dst[ 0 ] = 1
  dst[ 1 ] = 0
  dst[ 2 ] = 0
 ...
 */
export function translate(m: Mat4, v: v3.Vec3, dst?: Mat4): Mat4 {
  dst = dst || new Float32Array(16)
  const v0 = v[ 0 ]
  const v1 = v[ 1 ]
  const v2 = v[ 2 ]
 ...
 * angle.
 */
export function axisRotation(axis: v3.Vec3, angleInRadians: number, dst?: Mat4): Mat4 {
  dst = dst || new Float32Array(16)
  let x = axis[ 0 ]
  let y = axis[ 1 ]
  let z = axis[ 2 ]
 ...
 * given angle.
 */
export function axisRotate(m: Mat4, axis: v3.Vec3, angleInRadians: number, dst: Mat4): Mat4 {
  dst = dst || new Float32Array(16)
  let x = axis[ 0 ]
  let y = axis[ 1 ]
  let z = axis[ 2 ]
 ...
 * entries.
 */
export function scaling(v: v3.Vec3, dst?: Mat4): Mat4 {
  dst = dst || new Float32Array(16)
  dst[ 0 ] = v[ 0 ]
  dst[ 1 ] = 0
  dst[ 2 ] = 0
 ...
 * three entries.
 */
export function scale(m: Mat4, v: v3.Vec3, dst?: Mat4): Mat4 {
  dst = dst || new Float32Array(16)
  const v0 = v[ 0 ]
  const v1 = v[ 1 ]
  const v2 = v[ 2 ]
 ...
 */
export function transformPoint(m: Mat4, v: v3.Vec3, dst?: Mat4): v3.Vec3 {
  dst = dst || v3.create()
  const v0 = v[ 0 ]
  const v1 = v[ 1 ]
  const v2 = v[ 2 ]
 ...
 * entries.
 */
export function transformDirection(m: Mat4, v: v3.Vec3, dst?: Mat4): v3.Vec3 {
  dst = dst || v3.create()
  const v0 = v[ 0 ]
  const v1 = v[ 1 ]
  const v2 = v[ 2 ]
 ...
 * entries.
 */
export function transformNormal(m: Mat4, v: v3.Vec3, dst?: Mat4): v3.Vec3 {
  dst = dst || v3.create()
  const mi = inverse(m)
  const v0 = v[ 0 ]
  const v1 = v[ 1 ]
